...
Comparison Principles pilot. The pilot closes over its admitted class and carries the
...
def theoremSpecificEndgamePilotClosed : Prop :=
  forall A : AdmissibleClass, ConstrainedComparisonClosure A

theorem theorem_specific_endgame_pilot_checked :
    theoremSpecificEndgamePilotClosed := by
  intro A
  exact constrained_comparison_endgame A
